...
from orchestration.checks import parquet_backlog_reasonable, redpanda_consumer_lag_reasonable
...
from orchestration.schedules import cleanup_parquet_schedule, pipeline_schedule
...
defs = Definitions(
    ...
    asset_checks=[parquet_backlog_reasonable, redpanda_consumer_lag_reasonable],
    sensors=[bridge_heartbeat_sensor, parquet_landing_sensor, batch_raw_events_sensor],
    jobs=[cleanup_parquet_job, pipeline_job],
    schedules=[cleanup_parquet_schedule, pipeline_schedule],
)
